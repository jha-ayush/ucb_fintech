...
def setup():
    ...
    genesis_block=Block(record=Record(sender='Genesis',receiver='Genesis',amount=0),creator_id=42)
...
# YOUR CODE HERE
sender=st.text_input("Sender_Info")

# @TODO:
# Add an input area where you can get a value for `receiver` from the user.
# YOUR CODE HERE
receiver=st.text_input("Receiver_Info")

# @TODO:
# Add an input area where you can get a value for `amount` from the user.
# YOUR CODE HERE
amount=st.text_input("Amount_Info")
